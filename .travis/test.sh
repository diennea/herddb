...
mvn verify -Pjenkins -Dmaven.test.redirectTestOutputToFile=false -DforkCount=1 -Dherddb.file.requirefsync=false jacoco:report -Dtest=UseVirtualTableSpaceIdWithZookKeeperTest -DfailIfNoTests=false
