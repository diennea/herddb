 ...
 */
public class UseSystemPropertiesFromCommandLineTest {
    ...
    public void test() throws Exception {
        try {
            ...
            try (InputStream in = UseSystemPropertiesFromCommandLineTest.class.getResourceAsStream("/conf/test.server.properties")) {
            ...
            Thread runner = new Thread(() -> {
                ServerMain.main(tmpConfFile.getAbsolutePath(), "-D" + ServerConfiguration.PROPERTY_NODEID + "=my-node-id");
            });
            runner.start();
