 ...
 * @author diego.salvi
 */
public class DeleteThenInsertTest {
                ...
                try (BasicHerdDBDataSource dataSource = new BasicHerdDBDataSource(client)) {
                    ...
                    for (int run = 0; run < runs; ++run) {
                        ...
                        try (Connection con = dataSource.getConnection()) {
                            ...
                            try (PreparedStatement statement = con.prepareStatement("DELETE FROM mytable")) {
                                int deleted = statement.executeUpdate();
                                Assert.assertEquals(10, deleted);
                            }
                        ...
                        try (Connection con = dataSource.getConnection()) {
                            try (PreparedStatement statement = con
                                    .prepareStatement("SELECT k1 FROM mytable WHERE k1 = ?")) {
                                for (int id = 0; id < 10; ++id) {
