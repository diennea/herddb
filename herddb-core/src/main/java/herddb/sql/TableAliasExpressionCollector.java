...
/**
 * Collects all expressions referred to a given Alias
 *
 * @author enrico.olivelli
 */
public class TableAliasExpressionCollector implements ExpressionVisitor, ItemsListVisitor {

    private final String mainTableAlias;
    private List<Expression> expressions = new ArrayList<>();

    public TableAliasExpressionCollector(String mainTableAlias) {
        this.mainTableAlias = mainTableAlias;
    }

    private boolean isForMyAlias(Expression e) {
        TableAliasDiscovery discovery = new TableAliasDiscovery();
        e.accept(discovery);
        return discovery.getMainTableAlias() != null && discovery.getMainTableAlias().equalsIgnoreCase(mainTableAlias);
    }
