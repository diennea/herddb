...
public class ColumnNotEqualsJdbcParameter implements HardcodedPredicateMatcher {

    private final String columnName;
    private final int index;

    public ColumnNotEqualsJdbcParameter(String columnName, int index) {
    ...
    public boolean matches(Map<String, Object> bean, StatementEvaluationContext context) throws StatementExecutionException {
        ...
        return !SQLRecordPredicate.objectEquals(left, value);
    }
