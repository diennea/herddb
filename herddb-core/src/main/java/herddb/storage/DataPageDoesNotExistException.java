...
/**
 * Exception throwed when requested page doesn't exist.
 *
 * @author diego.salvi
 */
public class DataPageDoesNotExistException extends DataStorageManagerException {
    ...
    public DataPageDoesNotExistException(String message) {
        super(message);
    }

    public DataPageDoesNotExistException(Throwable cause) {
        super(cause);
    }
